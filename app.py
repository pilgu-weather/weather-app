...
def get_today_message(
    ...
    gap_messages = [
        ...
        "일교차가 있는 날엔 얇은 셔츠나 가벼운 레이어드가 잘 맞아요.",
    ...
    effective_feels_like_messages = [
        ...
        "오늘은 체감온도 기준으로 보면 살짝 따뜻하게 입는 게 좋아요.",
    ]
