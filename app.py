...
def home():
    ...
    if rain_mode:
        ...
        if rain_total_mm >= 30 or rain_score >= 8:
            ...
            rain_recommendation = (
                "비의 영향이 큰 날씨예요. 젖는 시간이 길어질 수 있어요. "
                "큰 우산이나 방수되는 겉옷이 도움이 될 수 있어요."
            )

        elif rain_total_mm >= 15 or rain_score >= 3:

            rain_recommendation = (
                "비가 체감에 영향을 줄 수 있는 날씨예요. 이동 중 젖는 구간이 생길 수 있어요. "
                "우산이나 물에 강한 신발이 편할 수 있어요."
            )

        elif rain_score >= 1:

            rain_recommendation = (
                "약한 비 영향이 있는 날씨예요. 짧은 이동에도 빗방울을 만날 수 있어요. "
                "작은 우산이 도움이 될 수 있어요."
            )
        ...
        if rain_recommendation:
            ...
            styles.insert(0, {
                ...
                "desc": (
                    ...
                    f"예상 누적 강수량 {rain_total_mm:.1f}mm예요.\n"
    ...
    if pm >= 4:
        ...
        styles.insert(0, {
            ...
            "desc": (
                "미세먼지 농도가 높은 편이에요. "
                "야외에서는 공기 상태가 답답하게 느껴질 수 있어요. "
                "마스크나 목을 덮는 실루엣이 도움이 될 수 있어요."
            )
    ...
    if (
        ...
        styles.insert(0, {
            ...
            "desc": (
                "일교차가 있는 날씨예요. "
                "낮과 저녁의 체감이 달라질 수 있어요. "
                "가벼운 외투나 레이어드가 편할 수 있어요."
            )
