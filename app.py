...
def get_today_message(
    ...
    rain_messages = [
        ...
        "오늘은 비에 대비해 방수 아우터를 더하면 좋아요.",
        "빗길이 예상돼요. 긴 바지와 미끄럽지 않은 신발을 추천해요.",
        "우산을 들기 좋은 날이에요. 가벼운 겉옷도 함께 챙겨주세요.",
        "비가 오면 체감이 낮아져요. 얇은 옷보다는 한 겹 더해보세요.",
        "습한 날씨라 통풍과 방수의 균형이 중요해요.",
        "Rainy mood예요. 어두운 컬러와 실용적인 아우터가 잘 맞아요.",
        "비 소식이 있어요. 짧은 하의보다는 안정적인 길이를 추천해요.",
        "우산을 챙기고, 물 튐에 강한 코디가 좋아요.",
        "비 오는 날엔 가벼운 레이어드와 방수 아이템이 든든해요.",
    ]

    thunder_messages = [
        "천둥 가능성이 있어요. 외출은 짧게, 아우터는 든든하게 챙겨주세요.",
        "강한 비가 올 수 있어요. 우산보다 방수 아우터가 더 실용적이에요.",
        "날씨 변화가 거칠 수 있어요. 활동성 좋은 긴 옷을 추천해요.",
        "천둥 예보가 있어요. 미끄럽지 않은 신발을 골라주세요.",
        "갑작스러운 비바람에 대비해 손이 자유로운 코디가 좋아요.",
        "오늘은 안정감 있는 착장이 잘 어울려요. 얇은 옷은 피해주세요.",
        "비바람이 강할 수 있어요. 짧은 하의보다는 긴 하의가 좋아요.",
        "Thunder mood예요. 방수성과 보온감을 함께 챙겨주세요.",
        "외출 전 날씨를 한 번 더 확인하고 우산을 준비해주세요.",
        "강한 소나기에 대비해 젖어도 티가 덜 나는 컬러를 추천해요.",
    ]

    wind_messages = [
        "바람이 강해요. 가벼운 아우터를 꼭 챙겨주세요.",
        "체감이 더 낮을 수 있어요. 긴 소매가 안정적이에요.",
        "바람 부는 날엔 얇은 옷 하나보다 레이어드가 좋아요.",
        "흩날리는 소재보다 몸에 편하게 잡히는 실루엣을 추천해요.",
        "강풍에는 짧은 하의보다 긴 하의가 더 편해요.",
        "오늘은 바람막이나 셔츠 아우터가 제 역할을 해줄 거예요.",
        "바람 때문에 쌀쌀하게 느껴질 수 있어요. 한 겹 더해보세요.",
        "가벼운 겉옷을 더하면 하루 종일 안정감 있게 입을 수 있어요.",
        "바람이 있는 날엔 목과 팔을 덮는 코디가 좋아요.",
        "실제 온도보다 차갑게 느껴질 수 있어요. 보수적으로 입어주세요.",
    ]

    gap_messages = [
        "일교차가 커요. 벗고 입기 쉬운 레이어드가 좋아요.",
        "아침과 낮의 온도 차가 있어요. 얇은 겉옷을 챙겨주세요.",
        "낮엔 가볍고 아침엔 쌀쌀할 수 있어요. 레이어드가 답이에요.",
        "큰 일교차엔 긴 소매와 가벼운 아우터 조합이 안정적이에요.",
        "온도 변화가 큰 날이에요. 너무 짧은 코디는 피하는 게 좋아요.",
        "아침저녁을 생각하면 한 겹 더하는 편이 안전해요.",
        "낮 기온만 보고 가볍게 입기엔 변수가 있어요.",
        "일교차가 있는 날엔 니트나 셔츠 레이어드가 잘 맞아요.",
        "하루 종일 입기 편하게 조절 가능한 코디를 추천해요.",
        "큰 온도 차에 대비해 아우터를 들고 나가면 좋아요.",
    ]
    ...
    temperature_messages = {
        "hot": [
            ...
            "오늘은 답답한 레이어드보다 단정한 한 벌이 좋아요.",
            "높은 기온엔 린넨이나 얇은 코튼이 잘 어울려요.",
            "긴 외출이라면 땀 배출이 쉬운 코디가 편해요.",
            "더운 날엔 액세서리보다 실루엣을 가볍게 가져가보세요.",
            "햇빛을 생각해 가벼운 긴소매도 좋은 선택이에요.",
            "시원한 착장이 필요한 날이에요. 신발도 가볍게 골라주세요.",
            "체온이 오르기 쉬워요. 몸에 붙지 않는 핏을 추천해요.",
            "무더위엔 심플하고 통기성 좋은 룩이 가장 좋아요.",
        ],
        "warm": [
            "따뜻한 날이에요. 가벼운 상의와 편한 하의가 잘 맞아요.",
            "기온은 높지만 실내 냉방을 생각해 얇은 겉옷도 좋아요.",
            "오늘은 너무 두껍지 않은 산뜻한 코디를 추천해요.",
            "밝은 톤과 가벼운 소재가 잘 어울리는 날이에요.",
            "반팔도 좋지만 저녁 외출엔 얇은 셔츠를 더해보세요.",
            "활동하기 좋은 온도예요. 통풍감 있는 룩이 편해요.",
            "가볍게 입되 길이감은 안정적으로 가져가도 좋아요.",
            "낮에는 따뜻해요. 얇고 여유 있는 핏을 추천해요.",
            "봄여름 사이 감성으로 산뜻하게 입기 좋은 날이에요.",
            "너무 짧게 가기보다 균형 있는 가벼운 코디가 좋아요.",
        ],
        "mild": [
            "쾌적한 온도예요. 얇은 긴소매나 셔츠가 잘 맞아요.",
            "가볍지만 너무 짧지 않은 코디가 안정적이에요.",
            "오늘은 셔츠, 얇은 니트, 긴 팬츠 조합이 좋아요.",
            "실내외 온도 차를 생각해 가벼운 레이어드를 추천해요.",
            "선선함이 살짝 있어요. 팔을 덮는 상의가 편할 수 있어요.",
            "활동하기 좋은 날이에요. 단정한 데일리룩을 추천해요.",
            "짧은 옷만 입기보다는 적당한 길이감이 좋아요.",
            "얇은 아우터를 더하면 아침저녁까지 편해요.",
            "오늘은 과하게 덥지 않아 미니멀한 긴 옷이 잘 어울려요.",
            "쾌적하지만 바람엔 서늘할 수 있어요. 한 겹을 생각해보세요.",
        ],
        "cool": [
        ...
        "freezing": [
            ...
            "두꺼운 상의와 긴 팬츠 조합을 추천해요.",
            "추운 날엔 레이어드가 가장 확실한 선택이에요.",
        ],
    }
